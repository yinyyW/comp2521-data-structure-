...
void test1(){
  ...
  prnPrev(it1, prnInt);
  add(it1, &new2);
  printf("After add 666, the list is:\n");
  prnIt(it1, prnInt);
  reset(it1);
  prnIt(it1, prnInt);
  reverse(it1);
  printf("After reverse:");
  printf("it has next?:%d\n", hasNext(it1));
  printf("it has previous?:%d\n", hasPrevious(it1));
  printf("Distance from start:%d\n", distanceFromStart(it1));
  printf("Distance to end:%d\n", distanceToEnd(it1));
  prnIt(it1, prnInt);
  printf("\n");
...
void test2(){
  ...
  prnIt(it1, prnInt);
  int new2 = 666;
  int res2 = set(it1, &new2);
  printf("> Set value: %d; return val:%d\n", new2, res2);
  prnPrev(it1, prnInt);
  prnPrev(it1, prnInt);
  int new3 = 777;
  int res3 = set(it1, &new3);
  printf("> Set value: %d; return val:%d\n", new3, res3);
  del(it1);
  reset(it1);
  prnIt(it1, prnInt);
...
void test6(){
  ...
  IteratorG advIt5 = advance(it,4);
  printf("> advance(it,4) returns: \n");
  assert(advIt5 != NULL);
  prnIt(advIt5, prnStr);
  printf("Does it have next? : %d\n", hasNext(it));
